...
\textbf{LaTeX} (['la:t$\epsilon ç] $ oder ['la:t$\epsilon \chi ])$ , ist ein Softwarepaket, das die Benutzung des Textsatzsystems TeX mit Hilfe von Makros vereinfacht. LaTeX liegt derzeit in der Version $2_\epsilon $ vor.
